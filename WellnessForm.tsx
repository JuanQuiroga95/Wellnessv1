        ...
        <div style={{ flexShrink:0, position:'relative' }}>
          ...
          >
            <defs>
              ...
              <filter id="xrayTint" colorInterpolationFilters="sRGB">
                <feColorMatrix type="matrix"
                  values="0.05 0    0.2  0 0.02
                          0.05 0.15 0.35 0 0.02
                          0.1  0.25 0.9  0 0.05
                          0    0    0    1 0"/>
              </filter>
            </defs>
            ...
            {/* Imagen rayos X - frontal normal, trasero espejado con transform SVG nativo */}
            {side === 'front' ? (
              <image
                href={XRAY_B64}
                x="10" y="8" width="180" height="385"
