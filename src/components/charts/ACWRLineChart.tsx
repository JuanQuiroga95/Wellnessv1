...
const Tip = ({ active, payload }: any) => {
  ...
  if (d.ratio < 0.8 || d.ratio > 1.2) statusColor = '#ef4444'
  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <LineChart data={data} margin={{ top: 20, right: 20, left: -20, bottom: 5 }}>
        ...
        <YAxis domain={[0.6, 1.3]} stroke="var(--fog)" fontSize={11} tickLine={false} axisLine={false} tickFormatter={(v) => v.toFixed(1)} />
        <Tooltip content={<Tip />} cursor={{ stroke:'rgba(255,255,255,.05)', strokeWidth: 2 }} />
        
        {/* Sweet Spot area */}
        <ReferenceArea y1={0.8} y2={1.2} fill="#84cc16" fillOpacity={0.1} />
        <ReferenceLine y={1.2} stroke="#84cc16" strokeDasharray="3 3" strokeWidth={1} opacity={0.5} />
        <ReferenceLine y={0.8} stroke="#84cc16" strokeDasharray="3 3" strokeWidth={1} opacity={0.5} />
