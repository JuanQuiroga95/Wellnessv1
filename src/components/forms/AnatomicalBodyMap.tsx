...
// VECTORES ANATÓMICOS REALES (Mismo sistema de coordenadas que el contorno)
const FRONT_GROUPS = [
  { id: 'pecho', label: 'Pectorales', color: '#f87171', paths: [
  ...
  { id: 'deltoides', label: 'Deltoides', color: '#fb923c', paths: [
  ...
  { id: 'biceps', label: 'Bíceps', color: '#fbbf24', paths: [
  ...
  { id: 'abdomen', label: 'Abdominales', color: '#4ade80', paths: [
  ...
  { id: 'oblicuos', label: 'Oblicuos', color: '#2dd4bf', paths: [
  ...
  { id: 'cuadriceps', label: 'Cuádriceps', color: '#60a5fa', paths: [
  ...
  { id: 'aductores', label: 'Aductores', color: '#818cf8', paths: [
...
const BACK_GROUPS = [
  { id: 'trapecio', label: 'Trapecio', color: '#f43f5e', paths: [
  ...
  { id: 'dorsales', label: 'Dorsales', color: '#f59e0b', paths: [
  ...
  { id: 'triceps', label: 'Tríceps', color: '#fbbf24', paths: [
  ...
  { id: 'antebrazos', label: 'Antebrazos', color: '#a3e635', paths: [
  ...
  { id: 'gluteos', label: 'Glúteos', color: '#22d3ee', paths: [
  ...
  { id: 'isquios', label: 'Isquiotibiales', color: '#6366f1', paths: [
  ...
  { id: 'gemelos', label: 'Gemelos', color: '#ec4899', paths: [
...
// SILUETAS ANATÓMICAS REALES (Outline)
      ...
      <div style={{ display: 'flex', gap: 48, alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap' }}>
        <div style={{ position: 'relative', width: 240, height: 480 }}>
          <svg viewBox={viewBox} width="100%" height="100%" style={{ display: 'block' }}>
            {/* ── SILUETA ANATÓMICA BASE (CHASIS) ── */}
            <path d={outline} fill="#1e293b" opacity="0.3" stroke="#334155" strokeWidth="0.5" />
              ...
              <g key={group.id} 
                ...
                {group.paths.map((d, i) => (
                  <path 
                    key={i} 
                    d={d} 
                    fill={selected === group.label ? group.color : hovered === group.label ? `${group.color}cc` : `${group.color}66`}
                    stroke={selected === group.label ? '#fff' : 'transparent'}
                    strokeWidth={selected === group.label ? 0.8 : 0}
            ...
            {/* Cabeza / Cuello base decorativa */}
            <path d={side==='front' ? "M44,10 c-4,0-7,3-7,8 s3,8 7,8 s7,-3 7,-8 s-3,-8 -7,-8 z" : "M132,10 c-4,0-7,3-7,8 s3,8 7,8 s7,-3 7,-8 s-3,-8 -7,-8 z"} fill="#1e293b" opacity="0.5" />
          </svg>
        </div>

        <div style={{ flex: 1, minWidth: 280 }}>
          <div style={{ background: 'rgba(255,255,255,0.02)', padding: 24, borderRadius: 20, border: '1px solid #1e293b', backdropFilter: 'blur(10px)' }}>
            <p style={{ fontSize: 10, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: 8 }}>Estatus de Selección</p>
            <h3 style={{ 
              color: selected ? (data.find(d => d.label === selected)?.color || '#fff') : (hovered ? '#fff' : '#475569'), 
              fontSize: 32, fontWeight: 900, marginBottom: 14, transition: 'color 0.2s' 
            }}>
              {selected || hovered || '—'}
            </h3>
            <p style={{ fontSize: 14, color: '#94a3b8', lineHeight: 1.6 }}>
              {selected ? `Has localizado el foco de dolor en: ${selected}. Por favor, indicá la intensidad en la escala EVA.` : 'Seleccioná un grupo muscular en el diagrama anatómico para reportar molestia.'}
            </p>
          </div>
              ...
              return (
                <button 
                  ...
                  style={{
                    ...
                    background: active ? `${group.color}20` : '#161d27',
                    color: active ? group.color : '#94a3b8',
                    fontWeight: active ? 800 : 500,
                    transition: 'all 0.2s',
                    boxShadow: active ? `0 0 15px ${group.color}20` : 'none'
                  }}
                >
                  {group.label}
                </button>
