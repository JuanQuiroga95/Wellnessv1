...
const ZONES = [
  ...
  { id: 'biceps_i',  label: 'Bíceps Izq.',     x: 175, y: 325, r: 22 },
  { id: 'biceps_d',  label: 'Bíceps Der.',     x: 350, y: 325, r: 22 },
  { id: 'codo_i',    label: 'Codo Izq.',       x: 163, y: 402, r: 20 },
  { id: 'codo_d',    label: 'Codo Der.',       x: 363, y: 402, r: 20 },
  { id: 'anteb_i',   label: 'Antebrazo Izq.',  x: 158, y: 468, r: 20 },
  { id: 'anteb_d',   label: 'Antebrazo Der.',  x: 368, y: 468, r: 20 },
  { id: 'abdomen',   label: 'Abdomen',         x: 263, y: 378, r: 38 },
  { id: 'muñeca_i',  label: 'Muñeca Izq.',     x: 153, y: 535, r: 18 },
  { id: 'muñeca_d',  label: 'Muñeca Der.',     x: 373, y: 535, r: 18 },
  { id: 'mano_i',    label: 'Mano Izq.',       x: 150, y: 590, r: 20 },
  { id: 'mano_d',    label: 'Mano Der.',       x: 375, y: 590, r: 20 },
  ...
  { id: 'cuad_i',    label: 'Cuádriceps Izq.', x: 238, y: 638, r: 38 },
  { id: 'cuad_d',    label: 'Cuádriceps Der.', x: 290, y: 638, r: 38 },
  { id: 'rodilla_i', label: 'Rodilla Izq.',    x: 235, y: 768, r: 22 },
  { id: 'rodilla_d', label: 'Rodilla Der.',    x: 290, y: 768, r: 22 },
  { id: 'tibia_i',   label: 'Tibia Izq.',      x: 230, y: 865, r: 28 },
  { id: 'tibia_d',   label: 'Tibia Der.',      x: 295, y: 865, r: 28 },
  { id: 'tobillo_i', label: 'Tobillo Izq.',    x: 228, y: 948, r: 18 },
  { id: 'tobillo_d', label: 'Tobillo Der.',    x: 297, y: 948, r: 18 },
