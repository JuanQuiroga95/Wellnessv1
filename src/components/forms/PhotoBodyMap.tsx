...
const ZONES = [
  // ── VISTA FRONTAL (centro ≈ x:263) ──────────────────────────────────────────
  { id: 'cabeza',    label: 'Cabeza',          x: 263, y: 78,  r: 42 },
  { id: 'cuello',    label: 'Cuello',          x: 263, y: 155, r: 18 },
  { id: 'hombro_i',  label: 'Hombro Izq.',     x: 178, y: 200, r: 28 },
  { id: 'hombro_d',  label: 'Hombro Der.',     x: 350, y: 200, r: 28 },
  { id: 'pecho_i',   label: 'Pecho Izq.',      x: 228, y: 272, r: 33 },
  { id: 'pecho_d',   label: 'Pecho Der.',      x: 298, y: 272, r: 33 },
  { id: 'biceps_i',  label: 'Bíceps Izq.',     x: 160, y: 325, r: 22 },
  { id: 'biceps_d',  label: 'Bíceps Der.',     x: 365, y: 325, r: 22 },
  { id: 'codo_i',    label: 'Codo Izq.',       x: 148, y: 402, r: 20 },
  { id: 'codo_d',    label: 'Codo Der.',       x: 378, y: 402, r: 20 },
  { id: 'anteb_i',   label: 'Antebrazo Izq.',  x: 143, y: 468, r: 20 },
  { id: 'anteb_d',   label: 'Antebrazo Der.',  x: 383, y: 468, r: 20 },
  { id: 'abdomen',   label: 'Abdomen',         x: 263, y: 378, r: 38 },
  { id: 'muñeca_i',  label: 'Muñeca Izq.',     x: 138, y: 535, r: 18 },
  { id: 'muñeca_d',  label: 'Muñeca Der.',     x: 388, y: 535, r: 18 },
  { id: 'mano_i',    label: 'Mano Izq.',       x: 135, y: 590, r: 20 },
  { id: 'mano_d',    label: 'Mano Der.',       x: 390, y: 590, r: 20 },
  { id: 'cadera_i',  label: 'Cadera Izq.',     x: 233, y: 462, r: 26 },
  { id: 'cadera_d',  label: 'Cadera Der.',     x: 293, y: 462, r: 26 },
  { id: 'aductor_i', label: 'Aductor Izq.',    x: 250, y: 545, r: 22 },
  { id: 'aductor_d', label: 'Aductor Der.',    x: 278, y: 545, r: 22 },
  { id: 'cuad_i',    label: 'Cuádriceps Izq.', x: 224, y: 638, r: 38 },
  { id: 'cuad_d',    label: 'Cuádriceps Der.', x: 304, y: 638, r: 38 },
  { id: 'rodilla_i', label: 'Rodilla Izq.',    x: 221, y: 768, r: 22 },
  { id: 'rodilla_d', label: 'Rodilla Der.',    x: 305, y: 768, r: 22 },
  { id: 'tibia_i',   label: 'Tibia Izq.',      x: 218, y: 865, r: 28 },
  { id: 'tibia_d',   label: 'Tibia Der.',      x: 308, y: 865, r: 28 },
  { id: 'tobillo_i', label: 'Tobillo Izq.',    x: 214, y: 948, r: 18 },
  { id: 'tobillo_d', label: 'Tobillo Der.',    x: 311, y: 948, r: 18 },
  { id: 'pie_i',     label: 'Pie Izq.',        x: 222, y: 990, r: 15 },
  { id: 'pie_d',     label: 'Pie Der.',        x: 302, y: 990, r: 15 },

  // ── VISTA POSTERIOR (centro ≈ x:762) ────────────────────────────────────────
  { id: 'nuca',      label: 'Nuca',              x: 762, y: 155, r: 22 },
  { id: 'trapecio',  label: 'Trapecio',          x: 762, y: 222, r: 35 },
  { id: 'h_back_i',  label: 'Hombro Izq.',       x: 665, y: 200, r: 28 },
  { id: 'h_back_d',  label: 'Hombro Der.',       x: 858, y: 200, r: 28 },
  { id: 'esp_alta',  label: 'Espalda Alta',      x: 762, y: 305, r: 48 },
  { id: 'triceps_i', label: 'Tríceps Izq.',      x: 645, y: 325, r: 22 },
  { id: 'triceps_d', label: 'Tríceps Der.',      x: 878, y: 325, r: 22 },
  { id: 'c_back_i',  label: 'Codo Izq.',         x: 632, y: 402, r: 20 },
  { id: 'c_back_d',  label: 'Codo Der.',         x: 892, y: 402, r: 20 },
  { id: 'lumbar',    label: 'Espalda Baja',      x: 762, y: 442, r: 38 },
  { id: 'm_back_i',  label: 'Muñeca Izq.',       x: 620, y: 535, r: 18 },
  { id: 'm_back_d',  label: 'Muñeca Der.',       x: 903, y: 535, r: 18 },
  { id: 'gluteo_i',  label: 'Glúteo Izq.',       x: 717, y: 495, r: 38 },
  { id: 'gluteo_d',  label: 'Glúteo Der.',       x: 808, y: 495, r: 38 },
  { id: 'isquio_i',  label: 'Isquiotibial Izq.', x: 717, y: 638, r: 43 },
  { id: 'isquio_d',  label: 'Isquiotibial Der.', x: 808, y: 638, r: 43 },
  { id: 'gemelo_i',  label: 'Gemelo Izq.',       x: 717, y: 798, r: 33 },
  { id: 'gemelo_d',  label: 'Gemelo Der.',       x: 808, y: 798, r: 33 },
  { id: 't_back_i',  label: 'Tobillo Izq.',      x: 717, y: 948, r: 18 },
  { id: 't_back_d',  label: 'Tobillo Der.',      x: 808, y: 948, r: 18 },
]
