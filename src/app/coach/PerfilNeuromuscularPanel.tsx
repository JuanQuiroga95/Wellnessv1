                            ...
                            <div style={{ height: 200, width: '100%' }}>
                              <ResponsiveContainer>
                                ...
                                >
                                  ...
                                  <Bar isAnimationActive={true} animationDuration={15000} dataKey="% Promedio Volumen" fill="#3b82f6" radius={[4,4,0,0]} barSize={40} />
                                  <Bar isAnimationActive={true} animationDuration={15000} dataKey="% Promedio Intensidad" fill="#f97316" radius={[4,4,0,0]} barSize={40} />
                                </BarChart>
                              </ResponsiveContainer>
                            </div>
                          </div>
                  ...
                  <div style={{ height:250 }}>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={evolution}>
                        ...
                        <Line isAnimationActive={true} animationDuration={15000} type="monotone" dataKey="max_vel" stroke="#3b82f6" strokeWidth={3} dot={{ r:4, fill:'#3b82f6' }} activeDot={{ r:6 }} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                  <div style={{ height:250 }}>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={evolution}>
                        ...
                        <YAxis domain={['auto', 'auto']} tick={{ fill:'var(--fog)', fontSize:10 }} axisLine={false} tickLine={false} />
                        <Tooltip contentStyle={{ background:'var(--ink)', border:'1px solid var(--mist)', borderRadius:12 }} />
                        <Area isAnimationActive={true} animationDuration={15000} type="monotone" dataKey="mts_min" stroke="#c8f135" strokeWidth={3} fillOpacity={1} fill="url(#colorMts)" />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                  <div style={{ height:250 }}>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={evolution}>
                        ...
                        <Line isAnimationActive={true} animationDuration={15000} name="Aceleraciones" type="monotone" dataKey="acel" stroke="#3b82f6" strokeWidth={2} dot={false} />
                        <Line isAnimationActive={true} animationDuration={15000} name="Desacel" type="monotone" dataKey="decel" stroke="#f97316" strokeWidth={2} dot={false} />
                        <Line isAnimationActive={true} animationDuration={15000} name="Sprints" type="monotone" dataKey="sprints" stroke="#c8f135" strokeWidth={2} dot={false} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                ...
                <div style={{ height:250 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={data?.weeklyGps || []}>
                      ...
                      <Tooltip contentStyle={{ background:'var(--ink)', border:'1px solid var(--mist)', borderRadius:12 }} />
                      <Legend iconType="circle" wrapperStyle={{ fontSize:10, paddingTop:10 }} />
                      <Area isAnimationActive={true} animationDuration={15000} name="Aceleraciones" type="monotone" dataKey="acel" stackId="1" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.4} />
                      <Area isAnimationActive={true} animationDuration={15000} name="Desaceleraciones" type="monotone" dataKey="decel" stackId="1" stroke="#f97316" fill="#f97316" fillOpacity={0.4} />
                      <Area isAnimationActive={true} animationDuration={15000} name="Sprints" type="monotone" dataKey="sprints" stackId="1" stroke="#c8f135" fill="#c8f135" fillOpacity={0.4} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
