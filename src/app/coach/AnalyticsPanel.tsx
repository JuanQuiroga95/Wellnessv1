              ...
              <div style={{ background:'var(--ink2)', border:'1px solid var(--mist)', borderRadius:20, padding:24, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center' }}>
                ...
                <div style={{ width:'100%', height:220 }}>
                  <ResponsiveContainer>
                    <PieChart>
                      <Pie data={[
                        { name: 'Aceleraciones', value: rows[0].avg_acel, color: '#3b82f6' },
                        { name: 'Desaceleraciones', value: rows[0].avg_decel, color: '#f97316' },
                        { name: 'Sprints', value: rows[0].avg_sprints * 10, color: '#c8f135' }
