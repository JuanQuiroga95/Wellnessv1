...
import { buildACWRHistory, buildDailyDetail, calcACWR } from '@/lib/acwr'
...
const DENSITY_TABLE: any = {
  acc_2: { "<10": { cant: 1.00, m: 5.80 }, "10-30": { cant: 2.10, m: 11.00 }, "30-50": { cant: 2.65, m: 13.90 }, "50-70": { cant: 2.70, m: 15.00 }, "70-100": { cant: 2.50, m: 14.00 }, "100-150": { cant: 2.30, m: 12.30 }, "150-180": { cant: 1.80, m: 9.60 }, "180-200": { cant: 1.50, m: 8.00 }, ">200": { cant: 1.25, m: 6.60 } },
  dec_2: { "<10": { cant: 1.30, m: 6.90 }, "10-30": { cant: 2.20, m: 11.80 }, "30-50": { cant: 2.90, m: 15.60 }, "50-70": { cant: 3.00, m: 10.00 }, "70-100": { cant: 2.70, m: 9.50 }, "100-150": { cant: 2.45, m: 13.20 }, "150-180": { cant: 1.95, m: 10.50 }, "180-200": { cant: 1.65, m: 8.80 }, ">200": { cant: 1.40, m: 7.50 } },
  acc_3: { "<10": { cant: 0.15, m: 1.20 }, "10-30": { cant: 0.30, m: 2.40 }, "30-50": { cant: 0.45, m: 3.60 }, "50-70": { cant: 0.40, m: 2.50 }, "70-100": { cant: 0.50, m: 3.30 }, "100-150": { cant: 0.40, m: 3.20 }, "150-180": { cant: 0.35, m: 2.80 }, "180-200": { cant: 0.30, m: 2.40 }, ">200": { cant: 0.28, m: 2.20 } },
  dec_3: { "<10": { cant: 0.20, m: 1.50 }, "10-30": { cant: 0.40, m: 3.00 }, "30-50": { cant: 0.60, m: 4.50 }, "50-70": { cant: 0.75, m: 2.00 }, "70-100": { cant: 0.65, m: 1.80 }, "100-150": { cant: 0.55, m: 4.10 }, "150-180": { cant: 0.45, m: 3.40 }, "180-200": { cant: 0.40, m: 3.00 }, ">200": { cant: 0.35, m: 2.60 } },
  hsr: { "<10": { cant: 0.00, m: 0.00 }, "10-30": { cant: 0.00, m: 0.00 }, "30-50": { cant: 0.05, m: 0.50 }, "50-70": { cant: 0.10, m: 0.90 }, "70-100": { cant: 0.18, m: 1.80 }, "100-150": { cant: 0.60, m: 10.00 }, "150-180": { cant: 0.75, m: 12.50 }, "180-200": { cant: 0.85, m: 14.20 }, ">200": { cant: 1.00, m: 16.50 } },
  sprint: { "<10": { cant: 0.00, m: 0.00 }, "10-30": { cant: 0.00, m: 0.00 }, "30-50": { cant: 0.00, m: 0.00 }, "50-70": { cant: 0.00, m: 0.00 }, "70-100": { cant: 0.02, m: 0.20 }, "100-150": { cant: 0.05, m: 1.50 }, "150-180": { cant: 0.12, m: 3.50 }, "180-200": { cant: 0.20, m: 5.80 }, ">200": { cant: 0.30, m: 8.50 } }
};
...
function ControlCargaCalcPanel({ teamData }: { teamData: any[] }) {
  ...
  const VARS = [
    ...
    {key:'nAcel',      label:'ACE >2 (n)',     color:'#ec4899', unit:'nº'},
    {key:'nDecel',     label:'DEC >2 (n)',     color:'#14b8a6', unit:'nº'},
    ...
    <div style={{ padding:'24px 20px', maxWidth:1400, margin:'0 auto' }}>
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', alignItems:'flex-end' }}>
          ...
          <button className="hover-scale" onClick={()=>{
            ...
            const GRUPOS_PDF = [
              ...
              {label:'Acc + Dec >2', bars:[{key:'nAcel',label:'ACE >2 (n)',color:'#ec4899'},{key:'nDecel',label:'DEC >2 (n)',color:'#14b8a6'}], lineKey:null},
      ...
      <div style={{ marginBottom:20 }}>
        ...
        {mdCols.map((md:string) => {
          ...
          const SESSION_VARS = [
            {key:'distTotal',  label:'DT (m)',          color:'#f59e0b'},
            {key:'distSprint', label:'HSR (m)',         color:'#f97316'},
            {key:'nSprints',   label:'HSR (n)',         color:'#a78bfa'},
            {key:'nAcel',      label:'ACE >2 (n)',      color:'#ec4899'},
                ...
                {(() => {
                  ...
                  const GROUPS = [
                    ...
                    },
                    {
                      ...
                      bars: [
                        { key:'nDecel', label:'DEC >2 (n)', color:'#ef4444' },
                        { key:'nAcel',  label:'ACE >2 (n)', color:'#3b82f6' },
                      ],
                      line: null,
                    },
                    {
